...
When contributing to this repository, please refer to our pull request process.
...
4. Add a default INSTRUCTIONS.md to your template to explain workers, what they should do.
5. Add the template to the content section of the main [README.md](README.md)
...
### Example
Take a look at the [PolygonAnnotation](./templates/PolygonAnnotation/) tool, for an example of a good template.
